...
def get_models():
    ...
    # ComplementNB
    models['cnb'] = ComplementNB(alpha=0.3)

    # Soft Voting
    models['vote_soft'] = VotingClassifier(
        estimators=[
            ('svm1', CalibratedClassifierCV(LinearSVC(C=1.0, dual=False, class_weight='balanced', max_iter=10000, random_state=SEED))),
            ('svm2', CalibratedClassifierCV(LinearSVC(C=2.0, dual=False, class_weight='balanced', max_iter=10000, random_state=SEED))),
