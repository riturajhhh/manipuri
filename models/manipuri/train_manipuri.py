...
def load_combined_data():
    ...
    # Path to original small dataset (mostly 'other' emotions)
    path1 = os.path.join(base_dir, 'manipuri_emotion_dataset_main1.xlsx')
    print(f"Loading {path1}...")
    df1 = pd.read_excel(path1)

    # Path to new 100k generated dataset
    path2 = os.path.join(base_dir, 'meitei_emotion_dataset_100k.csv')
...
def train():
    ...
    # Save
    model_dir = os.path.join(os.path.dirname(__file__), "manipuri_ultra_final")
